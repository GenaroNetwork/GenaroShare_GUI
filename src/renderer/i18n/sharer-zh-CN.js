...
exports.default = {
  ...
  dashboard: {
    ...
    drive: {
      ...
      showReward: '我的收益',
      yourReward: '您的收益',
      yourStakeWallet: '您押注的钱包: ',
      youHaveEarned: '您已经获取到: ',
      transferFeeTip: '提取手续费: ',
      youWillGet: '您将获取到: ',
      afterTransferTip: 'GNX提取中,交易哈希值: ',
      viewInEtherscan: '查看详细信息',
      stakeWallet: '押注钱包',
      driverId: '分享节点ID',
      quantity: '押注额',
      setStakeMonthTip: '设置要分享的时长',
      chooseDuration: '选择时长',
      wallet: '钱包',
      chooseStakeWallet: '选择要用来押注的钱包',
      chooseWallet: '选择钱包',
      walletPassword: '钱包密码',
      inputWalletPassword: '请输入您的钱包密码',
      setQuantityTip: '设置押注额',
      option: '选项',
      stakeTransaction: '押注交易',
      stakeSuccessTip: '交易已成功发起,哈希值为: ',
      restartConfirmTip: '您确定要重启您的分享节点吗?',
      startConfirmTip: '您确定要启动您的分享节点吗?',
      stopConfirmTip: '您确定要暂停您的分享节点吗? 您可以之后任何时候重启, 但用户在您暂停期间无法获取到存储的问题, 因此这期间您无法继续获取到收益并且也会降低您的节点信誉值.',
      deleteConfirmTip: '您确定要删除您的分享节点吗? 若该节点已押注, 押注期内, 押注的GNX无法使用. 请先确认你已备份节点配置以便找回. 您将丢失所有存储在您设备上的数据并无法获取收益, 同时也会降低您的设备的信誉值.',
      stakeFirstTip: '请先押注',
