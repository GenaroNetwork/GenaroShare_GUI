...
exports.default = {
  ...
  dashboard: {
    ...
    drive: {
      ...
      yourStakeWallet: 'Your stake wallet: ',
      youHaveEarned: 'You have earned: ',
      transferFeeTip: 'The transfer fee will be: ',
      youWillGet: 'You will get : ',
      afterTransferTip: 'GNX transferring. Transaction hash: ',
      viewInEtherscan: 'view in etherscan',
      stakeWallet: 'Stake Wallet',
      driverId: 'Driver ID',
      quantity: 'Quantity',
      setStakeMonthTip: 'Set the option for months to be shared', 
      chooseDuration: 'choose duration',
      wallet: 'wallet',
      chooseStakeWallet: 'Choose a wallet to stake',
      chooseWallet: 'choose a wallet',
      walletPassword: 'wallet password',
      inputWalletPassword: 'input your wallet password',
      setQuantityTip: 'set the quantity for stake, and will get a respond of size of sharing',
      option: 'option',
      stakeTransaction: 'Stake Transaction',
      stakeSuccessTip: 'The transaction has been sent successfunlly.Transaction hash: ',
